    ...
    return (
        <div className="App flex flex-col items-center bg-light text-dark min-h-screen scroll-smooth">
            <div className="w-full max-w-[1920px]">
                ...
                <header className="bg-white shadow-md border-b">
                    <nav className="max-w-7xl mx-auto flex justify-between items-center p-4">
                        ...
                        <div className="md:hidden px-8">
                            <button onClick={() => setMenuOpen(!menuOpen)} className="focus:outline-none text-secondary">
                    ...
                    >
                        ...
                        <a href="#services" className="text-secondary" onClick={() => setMenuOpen(false)}>Компетенции</a>
                ...
                {/* О нас */}
                <section id="about" className="bg-white mx-auto flex flex-col items-center py-8 px-6 text-center">
                ...
                <footer id="contacts" className="bg-white text-light py-8 px-4 text-center text-secondary border-t">
                    <h3 className="text-2xl text-primary font-semibold mb-4">Контакты</h3>
                    <p className="text-primary">Остались вопросы? Обязательно нас спросите :)</p>
